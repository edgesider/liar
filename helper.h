...
#define _log(prefix, format, args...)                                          \
  do {                                                                         \
...
static int syscall_args2array(struct user_regs_struct *regs, arg_t *argarr,
                              int args) {
  switch (args) {
  case 6:
    argarr[5] = regs->r9;
...
static int syscall_array2args(struct user_regs_struct *regs, arg_t *argarr,
                              int args) {
  switch (args) {
  case 6:
    regs->r9 = argarr[5];
